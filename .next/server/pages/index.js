...
async function getStaticProps() {
  const client = await external_mongodb_.MongoClient.connect('mongodb+srv://pranesh:7GenmTOwywJkH5A3@nextjs.31mvz.mongodb.net/meetups?retryWrites=true&w=majority');
  const db = client.db();
